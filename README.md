...
#### Much more examples and a detailed description can be found at [📄 Order details documentation page](https://mdbootstrap.com/docs/standard/extended/order-details/)
